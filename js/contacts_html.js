...
function contactCardHTML(index) {
    return /*html*/ `
        <div class="contact-div-big">
            ...
            <div id="delete-contact-container" onclick="requestDelete('request-delete-contact-popup')">
                <div id="delete-contact" class="edit-contact">
                    <img src="./assets/img/delete.png">
                    <span id="delete-contact-text">Delete Contact</span>
                </div>
            </div>
